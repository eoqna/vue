    ...
    export default {
        ...
        methods: {
            onClickTd() {
                ...
                if(rootData.tableData[0][this.rowIndex] === rootData.turn && rootData.tableData[1][this.rowIndex] === rootData.turn && rootData.tableData[2][this.rowIndex] === rootData.turn ) {
                    win = true;
                }
                ...
                if(win) { // 이긴 경우 : 3줄 달성
                    ...
                    let all = true; // all이 trun면 무승부라는 뜻
